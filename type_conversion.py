...
def explicit_type_conversion():
    ...
    print("Data type of interger_type after type conversion: ", type(float(integer_type)))
    print("Data type of interger_type after type conversion: ", type(str(integer_type)), str(integer_type))
